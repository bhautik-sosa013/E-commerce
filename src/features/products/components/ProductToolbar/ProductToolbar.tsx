  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-20 pb-8 border-b border-[#3D1A12]/10">
      <div className="flex items-center gap-4 w-full md:w-auto">
        <SearchBar />
        <button
          className="p-4 bg-white rounded-2xl text-[#3D1A12] hover:bg-[#EFEBE9] transition-colors md:hidden"
      ...
      <div className="flex items-center gap-4 w-full md:w-auto">
        <div className="hidden md:flex bg-white p-1 rounded-xl gap-1">
          ...
          <button
            className="p-2 bg-[#EFEBE9] rounded-lg text-[#3D1A12]"
          ...
          <button
            className="p-2 text-[#3D1A12]/40 hover:text-[#3D1A12]"
