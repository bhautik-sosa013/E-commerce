      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-1 md:order-2">
          ...
          <div className="inline-block bg-[#D4AF37]/10 px-4 py-2 rounded-full mb-6 border border-[#D4AF37]/20">
            <span className="text-[#3D1A12] font-bold text-xs tracking-widest uppercase">
              OUR STORY
            </span>
          </div>
          ...
          <div className="space-y-4 text-lg text-[#3D1A12]/70 leading-relaxed font-light">
            <p>
              We started with a simple mission: create the perfect iPhone case.
              One that protects without adding bulk, showcases Apple's beautiful
              design, and feels premium in your hand.
            </p>
            <p>
              Today, we're trusted by over 500,000 iPhone users worldwide. Our
              cases combine military-grade protection with sleek aesthetics that
              complement your iPhone's design language.
            </p>
            <p className="font-semibold text-[#3D1A12]">
              Every case is precision-engineered for your specific iPhone model,
              ensuring perfect alignment with buttons, cameras, and wireless
              charging.
            </p>
          </div>
          ...
          <div className="flex gap-8 mt-8 border-t border-[#3D1A12]/10 pt-8">
            {[
              ...
              <div key={index}>
                ...
                <div className="text-xs uppercase tracking-widest text-[#3D1A12]/50 font-medium">
                  {stat.label}
                </div>
              </div>
            ))}
